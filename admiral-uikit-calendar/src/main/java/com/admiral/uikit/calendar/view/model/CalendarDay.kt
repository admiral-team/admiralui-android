package com.admiral.uikit.calendar.view.model

import com.admiral.uikit.core.ext.next
import com.admiral.uikit.core.ext.previous
import com.admiral.uikit.core.ext.yearMonth
import java.io.Serializable
import java.time.LocalDate
import java.time.YearMonth

data class CalendarDay internal constructor(
    val date: LocalDate,
    val owner: DayOwner
