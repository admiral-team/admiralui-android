...
import com.admiral.uikit.calendar.view.InternalCalendarView
...
import com.admiral.uikit.core.ext.getVerticalMargins
import com.admiral.uikit.core.ext.inflate
import com.admiral.uikit.core.ext.orZero
import com.admiral.uikit.calendar.view.model.MonthConfig
import com.admiral.uikit.calendar.view.model.NO_INDEX
...
internal class CalendarAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MonthViewHolder {
        ...
        val weekHolders = (1 until COUNT_DAYS_OF_WEEK)
    ...
    private fun createDayHolders(dayConfig: DayConfig) = (1..COUNT_DAYS_OF_WEEK).map { DayHolder(dayConfig) }
    ...
    private fun findVisibleMonthPosition(isFirst: Boolean): Int {
        ...
        if (visibleItemPos != RecyclerView.NO_POSITION) {
            ...
            if (visibleItemPx <= COUNT_DAYS_OF_WEEK) {
    ...
    private fun findVisibleDay(isFirst: Boolean): CalendarDay? {
        ...
        val findViewByPosition = layoutManager.findViewByPosition(visibleIndex)
        if (findViewByPosition != null && visibleIndex == NO_INDEX) {
            val monthRect = Rect()
            findViewByPosition.getGlobalVisibleRect(monthRect)
            ...
            return months[visibleIndex].weekDays.flatten()
                ...
                .firstOrNull {
                    val dayView =
                        findViewByPosition.findViewWithTag<View>(it.date.hashCode()) ?: return@firstOrNull false
    ...
    private companion object {
        const val COUNT_DAYS_OF_WEEK = 7
    }
}
