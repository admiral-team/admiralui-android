...
## Подключение
Поддерживается два способа подключения: `GithubPackages` и локальное развёртывание.
...
Все публичные методы и классы задокументированы. Дополнительно вы можете сгенерировать документацию к коду с помощью плагина [Dokka](https://github.com/Kotlin/dokka)
