...
fun Context.pixels(@DimenRes dimenRes: Int): Int {
...
fun Context.coloredDrawable(drawable: Drawable?, @ColorRes colorResId: Int): Drawable? {
...
fun Context.createRoundedRectangleDrawable(radius: ComponentsRadius): Drawable {
...
fun Context.createRoundedColoredRectangleDrawable(
...
fun Context.createRoundedColoredStrokeDrawable(
    radius: ComponentsRadius,
    colorState: ColorStateList
): Drawable {
    val shape = GradientDrawable()
