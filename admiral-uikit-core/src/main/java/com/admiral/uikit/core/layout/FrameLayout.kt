    ...
    init {
        parseAttrs(attrs, R.styleable.FrameLayout).use {
            isBackgroundTransparent = it.getBoolean(
                R.styleable.FrameLayout_admiralBackgroundIsTransparent,
                false
            )
            backgroundColorNormalEnabledPalette = ColorPaletteEnum.from(
                it.getIntOrNull(
                    R.styleable.FrameLayout_admiralBackgroundColorNormalEnabledPalette
                )
            )
            backgroundColorPressedPalette = ColorPaletteEnum.from(
                it.getIntOrNull(
                    R.styleable.FrameLayout_admiralBackgroundColorPressedPalette
                )
            )
        }
        invalidateBackground()
