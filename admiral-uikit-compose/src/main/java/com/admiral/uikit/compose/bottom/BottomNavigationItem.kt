package com.admiral.uikit.compose.bottom
            ...
            if (label != null) {
                Box(
                    Modifier
                        ...
                        .padding(horizontal = BOTTOM_NAVIGATION_ITEM_HORIZONTAL_PADDING.dp)
                ) { label() }
            }
        }
...
private fun MeasureScope.placeLabelAndIcon(
    ...
    val baselineOffset = COMBINED_ITEM_TEXT_BASELINE.dp.roundToPx()
...
private const val COMBINED_ITEM_TEXT_BASELINE = 19
private const val BOTTOM_NAVIGATION_ITEM_HORIZONTAL_PADDING = 12