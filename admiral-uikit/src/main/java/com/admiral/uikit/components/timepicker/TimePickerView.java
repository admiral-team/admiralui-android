...
public class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    private final TimePickerChip minuteView;
    private final TimePickerChip hourView;
    ...
    public TimePickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.admiral_material_timepicker, this);
