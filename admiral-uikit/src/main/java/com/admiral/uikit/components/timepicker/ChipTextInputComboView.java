...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
  ...
  private final TimePickerChip chip;
  ...
  public ChipTextInputComboView(
    ...
    LayoutInflater wrappedContextInflater = LayoutInflater.from(context);

    chip = (TimePickerChip) inflater.inflate(R.layout.admiral_material_time_chip, this, false);
    textInputLayout = (TextInputLayout) wrappedContextInflater.inflate(R.layout.admiral_material_time_input, this, false);
    editText = textInputLayout.getEditText();
    editText.setVisibility(INVISIBLE);

    editText.setTextColor(ViewExtKt.colorStateListUnion(
            this,
            ThemeManager.INSTANCE.getTheme().getPalette().getTextAccent(),
            ThemeManager.INSTANCE.getTheme().getPalette().getTextAccent(),
            ThemeManager.INSTANCE.getTheme().getPalette().getTextAccent(),
            ThemeManager.INSTANCE.getTheme().getPalette().getTextAccent(),
            ThemeManager.INSTANCE.getTheme().getPalette().getTextAccent(),
    ...
    textInputLayout.setBoxStrokeColor(ThemeManager.INSTANCE.getTheme().getPalette().getBackgroundAccent());
    ...
    if (VERSION.SDK_INT >= VERSION_CODES.Q) {
      Drawable cursorDrawable = editText.getTextCursorDrawable().mutate();
