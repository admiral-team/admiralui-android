...
class BadgesTest : ScreenshotTest {
    ...
    fun checkBadgesNormalEnabled() {
        ...
        onView(withId(R.id.badgesButton)).perform(BetterScrollTo(), ViewActions.click())
        onView(withId(R.id.btnNormalBadges)).perform(ViewActions.click())

        compareScreenshot(activity)
    }

    @Test
    fun checkBadgesNormalDisabled() {
        val intent = Intent().apply {
            putExtra(KEY_IS_TEST, true)
        }
        val activity = activityRule.launchActivity(intent)
    ...
    fun checkBadgesSmallEnabled() {
        ...
        onView(withId(R.id.mainMenuHome)).perform(ViewActions.click())
        onView(withId(R.id.badgesButton)).perform(BetterScrollTo(), ViewActions.click())
        onView(withId(R.id.btnSmallBadges)).perform(ViewActions.click())

        compareScreenshot(activity)
    }

    @Test
    fun checkBadgesSmallDisabled() {
        val intent = Intent().apply {
            putExtra(KEY_IS_TEST, true)
        }
        val activity = activityRule.launchActivity(intent)
