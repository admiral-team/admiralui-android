...
class ToolbarAutoTest : ClickerTest{
    ...
    fun openToolbarScreen() {
        onView(withId(R.id.toolbarButton)).perform(BetterScrollTo())
        onView(withId(R.id.toolbarButton)).perform(click())
        onView(withId(R.id.disabledTab)).perform(click())
        onView(withId(R.id.defaultTab)).perform(click())
        onView(withId(R.id.decrementImageView)).perform(click())
        onView(withId(R.id.decrementImageView)).perform(click())
        onView(withId(R.id.decrementImageView)).perform(click())
        onView(withId(R.id.incrementImageView)).perform(click())
        onView(withId(R.id.incrementImageView)).perform(click())
        onView(withId(R.id.incrementImageView)).perform(click())
