...
class ShimmersAutoTest : ClickerTest{
    ...
    @Test
    fun openShimmersScreen() {
        onView(withId(R.id.shimmerButton)).perform(BetterScrollTo())
        onView(withId(R.id.shimmerButton)).perform(click())
