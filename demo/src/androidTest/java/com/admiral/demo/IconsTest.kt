...
class IconsTest : ScreenshotTest {
    ...
    fun checkIconsOutline() {
        ...
        onView(withId(R.id.iconsButton)).perform(BetterScrollTo(), ViewActions.click())
        onView(withId(R.id.tabOutline)).perform(ViewActions.click())
