...
import com.admiral.demo.databinding.FmtButtonsSecondaryBinding
import com.admiral.demo.features.main.NavigationViewModel
import com.admiral.uikit.view.checkable.CheckableGroup

class SecondaryButtonsFragment : BaseFragment(
    layoutId = R.layout.fmt_buttons_secondary,
    menuId = R.menu.menu_appbar_info
) {

    private val navigationViewModel: NavigationViewModel by viewModels({ requireParentFragment() })

    private val binding by viewBinding(FmtButtonsSecondaryBinding::bind)
