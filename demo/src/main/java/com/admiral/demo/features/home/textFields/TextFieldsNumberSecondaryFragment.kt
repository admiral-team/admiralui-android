...
import com.admiral.demo.databinding.FmtTextFieldsNumberSecondaryBinding
import com.admiral.demo.features.main.NavigationViewModel
import com.admiral.themes.ThemeManager
import com.admiral.uikit.core.foundation.ColorState
import com.admiral.uikit.view.checkable.CheckableGroup

class TextFieldsNumberSecondaryFragment : BaseFragment(
    layoutId = R.layout.fmt_text_fields_number_secondary,
    menuId = R.menu.menu_appbar_info
) {

    private val navigationViewModel: NavigationViewModel by viewModels({ requireParentFragment() })
    private val binding by viewBinding(FmtTextFieldsNumberSecondaryBinding::bind)
