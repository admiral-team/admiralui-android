...
import com.admiral.demo.databinding.FmtCellsLabelTrailingBinding
import com.admiral.demo.features.main.NavigationViewModel
import com.admiral.uikit.view.checkable.CheckableGroup

class CellsLabelTrailingFragment : BaseFragment(R.layout.fmt_cells_label_trailing) {

    private val navigationViewModel: NavigationViewModel by viewModels({ requireParentFragment() })
    private val binding by viewBinding(FmtCellsLabelTrailingBinding::bind)
