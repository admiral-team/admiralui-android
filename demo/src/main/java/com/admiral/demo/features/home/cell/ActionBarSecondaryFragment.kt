...
import com.admiral.demo.databinding.FmtCellsActionBarSecondaryBinding
...
class ActionBarSecondaryFragment : BaseFragment(R.layout.fmt_cells_action_bar_secondary) {

    private val navigationViewModel: NavigationViewModel by viewModels({ requireParentFragment() })
    private val binding by viewBinding(FmtCellsActionBarSecondaryBinding::bind)
    ...
    private fun initTitleCell() {
        binding.titleCell.setOnTouchListener(
            object : ActionBarOnSwipeTouchListener(binding.titleCell, binding.actionBar2) {}
        )
    }
