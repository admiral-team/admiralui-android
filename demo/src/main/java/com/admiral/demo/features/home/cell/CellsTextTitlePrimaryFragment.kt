...
import com.admiral.demo.databinding.FmtCellsTextTitlePrimaryBinding
import com.admiral.demo.features.main.NavigationViewModel
import com.admiral.uikit.view.checkable.CheckableGroup

class CellsTextTitlePrimaryFragment : BaseFragment(R.layout.fmt_cells_text_title_primary) {

    private val navigationViewModel: NavigationViewModel by viewModels({ requireParentFragment() })
    private val binding by viewBinding(FmtCellsTextTitlePrimaryBinding::bind)
