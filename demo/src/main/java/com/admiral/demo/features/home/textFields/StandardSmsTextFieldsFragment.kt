...
import com.admiral.demo.databinding.FmtTextFieldsStandardSmsBinding
import com.admiral.demo.features.main.NavigationViewModel
import com.admiral.uikit.view.checkable.CheckableGroup

class StandardSmsTextFieldsFragment : BaseFragment(R.layout.fmt_text_fields_standard_sms) {

    private val navigationViewModel: NavigationViewModel by viewModels({ requireParentFragment() })
    private val binding by viewBinding(FmtTextFieldsStandardSmsBinding::bind)
