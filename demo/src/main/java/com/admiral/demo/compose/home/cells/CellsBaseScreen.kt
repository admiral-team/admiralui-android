    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(id = R.string.cells_base_cells_title),
                style = ThemeManagerCompose.typography.title1,
            )
            BaseCell(
                onClick = onCellsLeadingClick,
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.cells_leading_title),
            ...
            BaseCell(
                onClick = onCellsCenterClick,
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.cells_center_title),
                        unitType = CellUnitType.LEADING_TEXT
                    ),
                    IconCellUnit(
                        unitType = CellUnitType.TRAILING,
            ...
            BaseCell(
                onClick = onCellsTrailingClick,
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.cells_trailing_title),
                        unitType = CellUnitType.LEADING_TEXT
                    ),
                    IconCellUnit(
                        unitType = CellUnitType.TRAILING,
