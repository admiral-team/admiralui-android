...
fun InformersAndNotificationsScreen(
    onBackClick: () -> Unit = {},
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(id = R.string.informers_notifications_title),
                style = AdmiralTheme.typography.title1,
            )
            BaseCell(
                onClick = onInformersClick,
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.informers_title),
...
@Preview
@Composable
private fun InformersAndNotificationsScreenPreview() {
    AdmiralTheme {
