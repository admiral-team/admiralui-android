    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(id = R.string.informers_title),
                style = AdmiralTheme.typography.title1,
            )
            BaseCell(
                onClick = onInformersBigClick,
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.informers_big_title),
            ...
            BaseCell(
                onClick = onInformersSmallClick,
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.informers_small_title),
                        unitType = CellUnitType.LEADING_TEXT
                    ),
                    IconCellUnit(
                        unitType = CellUnitType.TRAILING,
...
@Preview
@Composable
private fun InformersScreenPreview() {
    AdmiralTheme {
        InformersScreen()
    }
}