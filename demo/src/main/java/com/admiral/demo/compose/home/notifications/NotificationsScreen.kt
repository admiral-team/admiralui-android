    ...
    Scaffold(
        ...
        Column(
            ...
            BaseCell(
                ...
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.notifications_toast_title),
            ...
            BaseCell(
                ...
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.notifications_static_title),
                        unitType = CellUnitType.LEADING_TEXT
                    ),
                    IconCellUnit(
                        unitType = CellUnitType.TRAILING,
            ...
            BaseCell(
                ...
                children = listOf(
                    TitleCellUnit(
                        text = stringResource(R.string.notifications_action_title),
                        unitType = CellUnitType.LEADING_TEXT
                    ),
                    IconCellUnit(
                        unitType = CellUnitType.TRAILING,
