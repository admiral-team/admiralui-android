...
import com.admiral.uikit.compose.tabs.underline.UnderlineSliderTabList
import com.admiral.uikit.compose.tabs.underline.UnderlineSliderTabListBadged
    ...
    Scaffold(
        ...
        topBar = {
            AdmiralCenterAlignedTopAppBar(
                ...
                title = stringResource(id = R.string.tabs_underline_slider_title)
            )
        }
    ) { padding ->
        Column(
...
@Preview
@Composable
fun UnderlineSliderTabsScreenPreview() {
    AdmiralTheme {
