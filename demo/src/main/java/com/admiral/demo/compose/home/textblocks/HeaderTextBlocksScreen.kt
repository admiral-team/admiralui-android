    ...
    Scaffold(
        ...
        topBar = {
            AdmiralCenterAlignedTopAppBar(
                ...
                title = stringResource(id = DemoRes.string.text_blocks_header_title),
...
@Preview
@Composable
private fun HeaderTextBlocksScreenPreview() {
    AdmiralTheme {
        HeaderTextBlocksScreen()
    }
}
