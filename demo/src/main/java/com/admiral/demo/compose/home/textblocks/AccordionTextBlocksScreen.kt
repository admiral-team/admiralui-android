    ...
    Scaffold(
        ...
        topBar = {
            AdmiralCenterAlignedTopAppBar(
                ...
                title = stringResource(id = DemoRes.string.text_blocks_accordion_title),
...
@Preview
@Composable
private fun AccordionTextBlocksScreenPreview() {
    AdmiralTheme {
        AccordionTextBlocksScreen()
    }
}