    ...
    Scaffold(
        ...
        topBar = {
            AdmiralCenterAlignedTopAppBar(
                ...
                title = stringResource(id = DemoRes.string.text_blocks_padding_title),
...
@Preview
@Composable
private fun PaddingTextBlocksScreenPreview() {
    AdmiralTheme {
        PaddingTextBlocksScreen()
    }
}