...
fun View.createRoundedRectangleDrawable(radius: ComponentsRadius): Drawable =
    context.createRoundedRectangleDrawable(radius)

fun View.createRoundedRectangleDrawable(
...
fun View.getCorrectRadius(@Px cornerRadius: Float): Float {
...
fun View.colorStateListForChecked(
...
fun View.colorStateListForSelected(
...
fun View.emptyColorStateList(): ColorStateList {
...
fun View.doOnPreDrawOnce(action: () -> Unit) {
...
fun View.getVerticalMargins(): Int {
